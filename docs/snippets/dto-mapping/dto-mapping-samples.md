...
- `ApplyOptionalProfilePatch` は PATCH の未指定と null 指定を区別します。
- `ToV2Response` は versioned DTO の形として link と明細数を追加します。
...
- 未指定と null 指定を区別したい → `OptionalPatchValue<T>`, `ApplyOptionalProfilePatch`
- versioned DTO を作りたい → `ToV2Response`
